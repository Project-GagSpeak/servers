...
public partial class GagSpeakHub
{
    ...
    private async Task DeleteUser(User user)
    {
        ...
        _GagSpeakMetrics.IncCounter(MetricsAPI.CounterUsersRegisteredDeleted, 1);
    ...
    private async Task UserLeaveGroup(GroupDto dto, string userUid)
    {
        ...
        if (ownerHasLeft)
        {
            ...
            {
                _logger.LogCallInfo(GagSpeakHubLogger.Args(dto, "Deleted"));
            ...
            else
            {
                ...
                {
                    _logger.LogCallInfo(GagSpeakHubLogger.Args(dto, "Migrated", groupHasMigrated.Item2));
