...
public partial class GagSpeakHub
{
    ...
    {
        _logger.LogCallInfo(GagSpeakHubLogger.Args(dto, reason));
    ...
    public async Task<GroupJoinDto> GroupCreate()
    {
        ...
        _logger.LogCallInfo(GagSpeakHubLogger.Args(gid));
    ...
    {
        _logger.LogCallInfo(GagSpeakHubLogger.Args(dto, amount));
    ...
    public async Task<List<BannedGroupUserDto>> GroupGetBannedUsers(GroupDto dto)
    {
        ...
        _logger.LogCallInfo(GagSpeakHubLogger.Args(dto, bannedGroupUsers.Count));
    ...
    public async Task<bool> GroupJoinFinalize(GroupJoinDto dto)
    {
        ...
        {
            _logger.LogCallInfo(GagSpeakHubLogger.Args(aliasOrGid, "TempInvite", oneTimeInvite.Invite));
        ...
        _logger.LogCallInfo(GagSpeakHubLogger.Args(aliasOrGid, "Success"));
    ...
    {
        _logger.LogCallInfo(GagSpeakHubLogger.Args(dto, days, execute));
