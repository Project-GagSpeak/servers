...
public class GagSpeakCensus : IHostedService
{
    ...
    private readonly ILogger<GagSpeakCensus> _logger;
    ...
    public GagSpeakCensus(ILogger<GagSpeakCensus> logger, string xivApiKey)
    {
        _logger = logger;
    ...
    public async Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        _gauge = Metrics.CreateGauge("GagSpeak_census", "GagSpeak informational census data", new[] { "dc", "world", "gender", "race", "subrace" });
    }
