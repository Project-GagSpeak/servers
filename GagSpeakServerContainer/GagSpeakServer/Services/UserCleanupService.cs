...
public class UserCleanupService : IHostedService
{
    ...
    public UserCleanupService(GagSpeakMetrics metrics, ILogger<UserCleanupService> logger, IServiceProvider services, IConfigurationService<ServerConfiguration> configuration)
    {
    ...
    private async Task PurgeTempInvites(GagSpeakDbContext dbContext)
    {
        try
        {
