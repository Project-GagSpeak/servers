...
public class OnlineSyncedPairCacheService
{
    ...
    public OnlineSyncedPairCacheService(ILogger<OnlineSyncedPairCacheService> logger, ILoggerFactory loggerFactory, GagSpeakMetrics GagSpeakMetrics)
    {
        _logger = logger;
    ...
    public async Task InitPlayer(string user)
    {
        ...
        try
        {
            ...
            _lastSeenCache[user] = new(_loggerFactory.CreateLogger<PairCache>(), user, _GagSpeakMetrics);
        }
        finally
        {
    ...
    private sealed class PairCache : IDisposable
    {
        ...
        public PairCache(ILogger<PairCache> logger, string owner, GagSpeakMetrics metrics)
        {
