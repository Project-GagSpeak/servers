...
namespace GagSpeakShared.Migrations
{
    ...
    [Migration("20260316052928_2026-03-15TableRename")]
    partial class _20260315TableRename
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GagspeakShared.Models.GlobalPermissions", b =>
                {
                    ...
                    b.Property<bool>("GlobalArousal")
                        .HasColumnType("boolean")
                        .HasColumnName("global_arousal");

                    b.Property<bool>("GlobalGagTraits")
                        .HasColumnType("boolean")
                        .HasColumnName("global_gag_traits");

                    b.Property<bool>("GlobalRestraintTraits")
                        .HasColumnType("boolean")
                        .HasColumnName("global_restraint_traits");

                    b.Property<bool>("GlobalRestrictionTraits")
                        .HasColumnType("boolean")
                        .HasColumnName("global_restriction_traits");
            ...
            modelBuilder.Entity("GagspeakShared.Models.LikesLoci", b =>
                {
                    b.Property<string>("UserUID")
                        .HasColumnType("character varying(10)")
                        .HasColumnName("user_uid");

                    b.Property<Guid>("LociStatusId")
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("GagspeakShared.Models.LociKeyword", b =>
                {
            ...
            modelBuilder.Entity("GagspeakShared.Models.LociStatus", b =>
                {
                    ...
                    b.Property<byte>("ChainType")
                        .HasColumnType("smallint")
                        .HasColumnName("chain_type");

                    b.Property<Guid>("ChainedGUID")
                        .HasColumnType("uuid")
                        .HasColumnName("chained_guid");
                    ...
                    b.Property<int>("StackToChain")
                        .HasColumnType("integer")
                        .HasColumnName("stack_to_chain");
            ...
            modelBuilder.Entity("GagspeakShared.Models.PairPermissionAccess", b =>
                {
                    ...
                    b.Property<short>("LociAccessAllowed")
                        .HasColumnType("smallint")
                        .HasColumnName("loci_access_allowed");

                    b.Property<bool>("LociEnabledAllowed")
                        .HasColumnType("boolean")
                        .HasColumnName("loci_enabled_allowed");
                    ...
                    b.Property<bool>("MaxLociTimeAllowed")
                        .HasColumnType("boolean")
                        .HasColumnName("max_loci_time_allowed");
            ...
            modelBuilder.Entity("GagspeakShared.Models.PairPermissions", b =>
                {
                    ...
                    b.Property<bool>("ArousalManipulation")
                        .HasColumnType("boolean")
                        .HasColumnName("arousal_manipulation");
                    ...
                    b.Property<bool>("GagTraits")
                        .HasColumnType("boolean")
                        .HasColumnName("gag_traits");
                    ...
                    b.Property<bool>("RestraintTraits")
                        .HasColumnType("boolean")
                        .HasColumnName("restraint_traits");

                    b.Property<bool>("RestrictionTraits")
                        .HasColumnType("boolean")
                        .HasColumnName("restriction_traits");
            ...
            modelBuilder.Entity("GagspeakShared.Models.ReportedChat", b =>
                {
                    ...
                    b.Property<string>("CompressedChatHistory")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("compressed_chat_history");
                    ...
                    b.HasKey("ReportID")
                        .HasName("pk_reported_chats");

                    b.HasIndex("ReportedUserUID")
                        .HasDatabaseName("ix_reported_chats_reported_user_uid");

                    b.HasIndex("ReportingUserUID")
                        .HasDatabaseName("ix_reported_chats_reporting_user_uid");

                    b.ToTable("reported_chats", (string)null);
                });

            modelBuilder.Entity("GagspeakShared.Models.ReportedProfile", b =>
                {
                    b.Property<int>("ReportID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("GagspeakShared.Models.UserCollarData", b =>
                {
                    ...
                    b.Property<byte>("LociDataType")
                        .HasColumnType("smallint")
                        .HasColumnName("loci_data_type");

                    b.Property<string>("LociDescription")
                        .HasColumnType("text")
                        .HasColumnName("loci_description");

                    b.Property<long>("LociIconId")
                        .HasColumnType("bigint")
                        .HasColumnName("loci_icon_id");

                    b.Property<Guid>("LociStatusId")
                        .HasColumnType("uuid")
                        .HasColumnName("loci_status_id");

                    b.Property<string>("LociTitle")
                        .HasColumnType("text")
                        .HasColumnName("loci_title");

                    b.Property<string>("LociVFXPath")
                        .HasColumnType("text")
                        .HasColumnName("loci_vfx_path");
            ...
            modelBuilder.Entity("GagspeakShared.Models.UserHardcoreState", b =>
                {
                    b.Property<string>("UserUID")
                        .HasColumnType("character varying(10)")
                        .HasColumnName("user_uid");
            ...
            modelBuilder.Entity("GagspeakShared.Models.LikesLoci", b =>
                {
                    b.HasOne("GagspeakShared.Models.LociStatus", "LociStatus")
                        .WithMany("LikesLoci")
            ...
            modelBuilder.Entity("GagspeakShared.Models.LikesPatterns", b =>
                {
                    b.HasOne("GagspeakShared.Models.PatternEntry", "PatternEntry")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_likes_patterns_pattern_entry_pattern_entry_id");
            ...
            modelBuilder.Entity("GagspeakShared.Models.ReportedChat", b =>
                {
                    b.HasOne("GagspeakShared.Models.User", "ReportedUser")
                        ...
                        .HasConstraintName("fk_reported_chats_users_reported_user_uid");

                    b.HasOne("GagspeakShared.Models.User", "ReportingUser")
                        .WithMany()
                        .HasForeignKey("ReportingUserUID")
                        .HasConstraintName("fk_reported_chats_users_reporting_user_uid");
            ...
            modelBuilder.Entity("GagspeakShared.Models.LociStatus", b =>
                {
                    b.Navigation("LikesLoci");

                    b.Navigation("LociKeywords");
                });
