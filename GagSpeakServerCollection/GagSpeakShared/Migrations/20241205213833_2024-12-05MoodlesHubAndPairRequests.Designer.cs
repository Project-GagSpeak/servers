...
namespace GagSpeakShared.Migrations
{
    ...
    [Migration("20241205213833_2024-12-05MoodlesHubAndPairRequests")]
    partial class _20241205MoodlesHubAndPairRequests
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GagspeakShared.Models.LikesPatterns", b =>
                {
                    ...
                    b.Property<Guid?>("MoodleStatusIdentifier")
                        .HasColumnType("uuid")
                        .HasColumnName("moodle_status_identifier");

                    b.HasKey("UserUID", "PatternEntryId")
                        .HasName("pk_likes_patterns");

                    b.HasIndex("MoodleStatusIdentifier")
                        .HasDatabaseName("ix_likes_patterns_moodle_status_identifier");
            ...
            modelBuilder.Entity("GagspeakShared.Models.LikesPatterns", b =>
                {
                    b.HasOne("GagspeakShared.Models.MoodleStatus", null)
                        .WithMany("UserPatternLikes")
                        .HasForeignKey("MoodleStatusIdentifier")
                        .HasConstraintName("fk_likes_patterns_moodles_moodle_status_identifier");
