...
namespace GagSpeakShared.Migrations
{
    ...
    [Migration("20250405161643_2024-04-05OnePointThreeDbUpdates")]
    partial class _20240405OnePointThreeDbUpdates
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GagspeakShared.Models.ClientPairPermissionAccess", b =>
                {
                    ...
                    b.Property<bool>("ApplyRestraintLayersAllowed")
                        .HasColumnType("boolean")
                        .HasColumnName("apply_restraint_layers_allowed");
            ...
            modelBuilder.Entity("GagspeakShared.Models.ClientPairPermissions", b =>
                {
                    ...
                    b.Property<bool>("ApplyRestraintLayers")
                        .HasColumnType("boolean")
                        .HasColumnName("apply_restraint_layers");
            ...
            modelBuilder.Entity("GagspeakShared.Models.UserGlobalPermissions", b =>
                {
                    ...
                    b.Property<int>("ChatGarblerChannelsBitfield")
                        .HasColumnType("integer")
                        .HasColumnName("chat_garbler_channels_bitfield");
                    ...
                    b.Property<bool>("ToysAreConnected")
                        .HasColumnType("boolean")
                        .HasColumnName("toys_are_connected");

                    b.Property<bool>("ToysAreInUse")
                        .HasColumnType("boolean")
                        .HasColumnName("toys_are_in_use");
            ...
            modelBuilder.Entity("GagspeakShared.Models.UserRestraintData", b =>
                {
                    ...
                    b.HasKey("UserUID")
                        .HasName("pk_user_restraint_data");

                    b.HasIndex("UserUID")
                        .HasDatabaseName("ix_user_restraint_data_user_uid");

                    b.ToTable("user_restraint_data", (string)null);
                });
            ...
            modelBuilder.Entity("GagspeakShared.Models.UserRestraintData", b =>
                {
                    b.HasOne("GagspeakShared.Models.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_restraint_data_users_user_uid");
